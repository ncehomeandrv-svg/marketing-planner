...
// Scope the production board to the displayed month. Future planning only shows noteworthy dates.
source=source.replace(
...
console.log('Planner production board and performance priority UI injected.');
